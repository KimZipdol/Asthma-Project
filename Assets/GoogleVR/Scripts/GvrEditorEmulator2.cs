...
public class GvrEditorEmulator2 : MonoBehaviour
{
    ...
    private static GvrEditorEmulator2 instance;
    ...
    public static GvrEditorEmulator2 Instance
    {
        get
        {
            if (instance == null && !instanceSearchedFor)
            {
                instance = FindObjectOfType<GvrEditorEmulator2>();
