...
public class GvrEditorEmulatorInhale : MonoBehaviour
{
    ...
    private static GvrEditorEmulatorInhale instance;
    ...
    public static GvrEditorEmulatorInhale Instance
    {
        get
        {
            if (instance == null && !instanceSearchedFor)
            {
                instance = FindObjectOfType<GvrEditorEmulatorInhale>();
